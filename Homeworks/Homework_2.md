...
| Паханцова Тетяна | `Pet` | Моделює домашню тварину. Повинен містити кличку, вид тварини, вік та рівень голоду та рівень радості. Методи мають дозволяти годувати тварину для зменшення голоду, гратися з нею (збільшувати радість) та перевіряти загальний стан. |
