...
## Практика проєктування та створення класів
...
| Карпенко Георгій | `MovieTicket` | Представляє квиток у кінотеатр. Повинен зберігати назву фільму, номер ряду, місце та ціну. Методи мають перевіряти, чи заброньований квиток, та розраховувати вартість з надбавкою за вихідний день.|
...
| Паханцова Тетяна | `Pet` | Моделює домашню тварину. Повинен містити кличку, вид тварини, вік та рівень голоду. Методи мають дозволяти годувати тварину для зменшення голоду, гратися з нею (збільшувати радість) та перевіряти загальний стан. |
...
| Скорик Тимур | `CoffeeMachine` | Моделює кавоварку. Містить рівень води, рівень кавових зерен, об'єм контейнера для відходів та стан готовності. Методи мають запускати приготування еспресо з перевіркою ресурсів, додавати воду та очищувати контейнер. |
| Табасаранська Лілія | `HotelRoom` | Описує номер у готелі. Має номер кімнати, клас комфорту, вартість доби проживання та статус зайнятості. Методи повинні бронювати номер на задану кількість днів, оформлювати виселення та розраховувати фінальну вартість проживання. |
